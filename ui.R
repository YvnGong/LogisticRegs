  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "explore",
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  bsButton("submitD", "Results for a New Sample", style="danger",icon("retweet"), size= "large"),
                ...
                mainPanel(
                  ...
                  fluidRow(h3("Adjust the inputs to complete the activity:")),
                  wellPanel(
                    
                    fluidRow(uiOutput("challenges"))
                  ),
                  
                  fluidRow(h3("Feedback:")),
                  
                  wellPanel(
                    
                    fluidRow(uiOutput("answers"))
                  ),
      ...
      tabItem(tabName = "qqq",
              ...
              fluidRow(h2("Tic-Tac-Toe"),
                       column(1,img(src = "pink.jpg", width = 20)),
                       h4("You will get an X for a correct answers and the computer will get an O for a wrong answer.")),
              fluidRow(
                column(4,
                       leafletOutput('image'),
                       br(),
